                          ...
                          while ($product = $stmt->fetch(PDO::FETCH_ASSOC)) {
                              ...
                              <tr>
                                  ...
                                  <td class="text-center">
                                        <!-- Example button for opening the modal update -->
                                    <button type="button" class="btn btn-sm btn-success" 
                                            ...
                                            data-category="<?= htmlspecialchars($product['cat_name']) ?>">
...
<script>
    ...
    <script>
        ...
        updateProductModal.addEventListener('show.bs.modal', function (event) {
            ...
            modalProductCategory = productCategoryId

            // Set the selected category
            modalProductCategory.value = productCategoryId;
        });

        // SweetAlert confirmation on update
        document.getElementById('updateProductForm').onsubmit = function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    // Create a hidden input to signify the update action
                    const input = document.createElement('input');
                    input.type = 'hidden';
                    input.name = 'updateProduct'; // This name matches your PHP condition
                    this.appendChild(input); // Append the input to the form
